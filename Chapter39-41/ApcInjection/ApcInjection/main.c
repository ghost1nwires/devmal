...
DWORD WINAPI DummyFunction(LPVOID lpParameter) {
...
WORD WINAPI AlertableFunction1(LPVOID lpParameter) {

	SleepEx(INFINITE, TRUE);
	return 0;
}

DWORD WINAPI AlertableFunction2(LPVOID lpParameter) {
...
DWORD WINAPI AlertableFunction3(LPVOID lpParameter) {
...
DWORD WINAPI AlertableFunction4(LPVOID lpParameter) {
...
DWORD WINAPI AlertableFunction5(LPVOID lpParameter) {
